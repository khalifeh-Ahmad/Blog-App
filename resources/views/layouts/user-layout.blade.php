...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/user/dashboard" wire:navigate class="logo d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
                        ...
                        @if (auth()->user()->unreadNotifications->count() > 0)
                            <span
                                class="badge bg-primary badge-number">{{ auth()->user()->unreadNotifications->count() }}
                                Notifications</span>
                        @endif
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="/user/dashboard" wire:navigate>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Kh.A</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Developed by <a href="https://www.linkedin.com/in/khalifeh-ahmad/">Eng. Khalifeh
                Ahmad</a>
        </div>
    </footer><!-- End Footer -->
